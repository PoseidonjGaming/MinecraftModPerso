...
public enum CustomItemTiers implements IItemTier {
    ...
    VIBRANIUM(5, 2150,13.0f, 5.0f,20, new LazyValue<>(()->{return Ingredient.of(ModItems.vibranium_ingot.get());}));
    ...
    CustomItemTiers(int p_i48458_3_, int p_i48458_4_, float p_i48458_5_, float p_i48458_6_, int p_i48458_7_, LazyValue<Ingredient> p_i48458_8_) {
